...
WORKBRANCH="$APP_ROOT/bin/workbranch"
...
main() {
  ...
  run_test test_init_temp_project_reports_registry_skip_without_registered_success
  ...
  run_test test_registry_tmpdir_root_does_not_treat_all_absolute_paths_as_temp
  ...
  run_test test_update_preflight_guidance_uses_project_root_from_subdirectory
  ...
  run_test test_add_prompts_for_task_name_only_on_shared_parent_feature_base
  run_test test_add_bare_tty_name_prefills_task_name_on_shared_parent_feature_base
  run_test test_add_mixed_bases_keep_conventional_task_identity_prompt
  run_test test_add_noninteractive_bare_name_keeps_legacy_folder_on_parent_feature_base
  run_test test_add_parent_feature_base_with_unsafe_folder_slug_keeps_legacy_default
  ...
  run_test test_list_json_base_repos_require_exact_worktree_root
  run_test test_list_json_base_repos_preserve_branch_and_detached_head
  run_test test_list_json_base_repo_inaccessible_parent_is_not_missing
  ...
  run_test test_ide_vscode_family_preset_prefers_bundled_cli_when_installed
  run_test test_ide_legacy_app_shape_uses_bundled_cli_after_normalization
  run_test test_ide_bundled_cli_activates_running_app_after_focusing_repo
  run_test test_ide_bundled_cli_normalizes_sonoma_front_asn_before_bundle_lookup
  run_test test_ide_bundled_cli_reactivates_when_focus_returns_to_caller
  run_test test_ide_bundled_cli_skips_activation_when_app_not_running
  run_test test_ide_non_vscode_family_preset_keeps_configured_open_command
  run_test test_ide_vscode_family_preset_falls_back_to_open_when_bundled_cli_missing
  ...
  run_test test_interactive_init_temp_project_reports_registry_skip_without_registered_success
